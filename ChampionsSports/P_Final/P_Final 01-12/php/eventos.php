...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
     ...
     <style>
        /* Define o tamanho para o ícone da categoria do evento */
        .event-category-icon {
            width: 60px;  /* Largura desejada */
            height: 64px; /* Altura desejada */
            margin-right: 8px; /* Espaçamento à direita para separar do texto */
        }
     </style>
</head>
                    ...
                    <div class="event-card">
                        <div class="event-content">
                            <p class="event-category">
                                <img src="../img/jogador.png" alt="Ícone de Futebol" class="event-category-icon">
                            ...
                            <div class="event-info">
                                ...
                                <!-- Este botão será um link preenchido pelo JavaScript -->
                                <a href="#" class="event-location-link" target="_blank" rel="noopener noreferrer">
            ...
            <div class="footer-columns">
                ...
                <div class="footer-links">
                    ...
                    <ul>
                        ...
                        <li><a href="sobre.php">Sobre</a></li>
                        <li><a href="contato.php">Contato</a></li>
                        <li><a href="termos.php"></a>Termos de Uso</a></li>
