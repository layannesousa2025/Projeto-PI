...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check_stmt->num_rows > 0) {
        ...
        try {
            ...
            $insert_access_sql = "INSERT INTO acessibilidade (d_visual, d_auditiva, d_motora, d_cardiaca, d_intelectual, d_neurologica, d_psiquica, outros, id_cadastro_usuario) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
