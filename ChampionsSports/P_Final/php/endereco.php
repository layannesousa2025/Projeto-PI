...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // Isso requer que a coluna 'id_usuarios' seja uma chave única (UNIQUE KEY) na tabela 'endereco'.
        $sql = "
            INSERT INTO endereco (id_usuarios, cep, uf, rua, bairro, cidade, complemento) 
            VALUES (?, ?, ?, ?, ?, ?, ?)
