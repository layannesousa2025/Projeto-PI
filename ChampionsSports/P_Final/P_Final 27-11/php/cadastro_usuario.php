...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check_stmt->num_rows > 0) {
        ...
        try {
            ...
            // CORREÇÃO: Os nomes das colunas foram ajustados para corresponder à estrutura provável da tabela (sem o prefixo 'd_').
            ...
            $_SESSION['id'] = $id_cadastro_usuario_novo; // ID da tabela 'cadastro_usuario'
            $_SESSION['nome'] = $nome;
            $_SESSION['id_cadastro_usuario'] = $id_cadastro_usuario_novo; // ID da tabela 'cadastro_usuario'
