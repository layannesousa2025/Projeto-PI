...
$port = 3306; // Porta consistente com o restante do projeto
...
if (isset($_FILES['foto_perfil'])) {
    ...
    try {
        ...
        // Atualiza a foto na tabela cadastro_usuario
        $stmt = $conn->prepare("UPDATE cadastro_usuario SET foto_perfil = ? WHERE id_cadastro_usuario = ?");
