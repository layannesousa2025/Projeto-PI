...
$port = 3306; // Porta correta do MySQL no XAMPP
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insere os dados do endereço na tabela, usando id_cadastro_usuario
    $insert_sql = "INSERT INTO endereco (cep, uf, rua, bairro, cidade, complemento, id_cadastro_usuario) 
                   VALUES (?, ?, ?, ?, ?, ?, ?)";
