...
<body>
  <header>
    ...
    <div class="login-button">
      <a href="usuario.php" class="btn-primary" style="text-decoration: none; padding: 10px 20px;"><?php echo htmlspecialchars($_SESSION['nome']); ?></a>
      <a href="logout.php" class="btn-outline" style="text-decoration: none; padding: 10px 20px; color: white;">Sair</a>
    </div>
    <?php else: ?>
