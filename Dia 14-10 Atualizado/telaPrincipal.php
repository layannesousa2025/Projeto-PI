...
<head>
  ...
  <style>
    .hero {
      background-image: url('esportes1.png');
      background-size: cover;
      background-position: center;
      background-repeat: no-repeat;
      color: white; /* Garante que o texto seja legível sobre a imagem */
      text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.7); /* Adiciona uma sombra para melhorar a legibilidade */
    }
  </style>
</head>
...
<body>
  <header>
    ...
    <div class="login-button">
      <a href="usuario.php" class="btn-primary" style="text-decoration: none; padding: 8px 15px;"><?php echo htmlspecialchars($_SESSION['nome']); ?></a>
      <a href="logout.php" class="btn-outline" style="text-decoration: none; padding: 8px 15px;">Sair</a>
    </div>
    <?php else: ?>
    <!-- Mostra isso se o usuário NÃO estiver logado -->
    <div class="login-button">
      <button class="btn-outline"><a href="./Login.html">Acessar</a></button>
  ...
  <section class="search-section" id="search">
    <div class="search-container">
      ...
      <div class="search-box">
        <input type="text" placeholder="Pesquise..." id="location-input">
        <button id="search-btn">Buscar</button>
      </div>
      <p>Ou use nosso chatbot abaixo para ajudar na sua busca</p>
    </div>
  </section>
