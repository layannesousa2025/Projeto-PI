...
<head>
    ...
    <link rel="stylesheet" href="ajustesAcessibilidade.css">
</head>
...
<body>
    ...
    <h2 style="text-align: center; color: #9e2020ff; margin-top: -10px; margin-bottom: 20px;">
        Busque Suas Categorias
    </h2>
   

    <p style="text-align: center; color: #0c0c0cff; margin-top: -10px; margin-bottom: 20px;">
    ...
    <script>
     ...
     <script src="ajustesAcessibilidade.js"></script>
</body>
